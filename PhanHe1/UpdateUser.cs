...
namespace PhanHe1
{
    public partial class UpdateUser : Form
    {
        ...
        private void LoadListUsers()
        {
            ...
            updateUserCbb.ValueMember = "Username";
        }
        ...
        {
            BLL bll = new BLL();
            var activeUser = updateUserCbb.SelectedValue.ToString();
            ...
            {
                MessageBox.Show($"Không thể đổi mật khẩu {activeUser} do lỗi bên hệ thống", "Lỗi",
                    MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
